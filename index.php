              ...
              <ul class="messages_layout">
                ...
                <li class="by_myself right"> <a href="#" class="avatar"><img src="img/message_avatar2.png"/></a>
                  <div class="message_wrap"> <span class="arrow"></span>
                    ...
                    <div class="text"> <img style="max-width:50%" src="https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1505109081280&di=d4bfc441042bfc73364f86af9ca1601a&imgtype=0&src=http%3A%2F%2Fwww.xz7.com%2Fup%2F2017-8%2F2017891713542540.jpg"> </div>
                  </div>
                </li>
            ...
            <div class="widget-content">
              <ul class="news-items">
                <li>
                  ...
                  <div class="news-item-detail"> <a class="news-item-title" target="_blank">Linux学习之路 # 4</a>
                    <p class="news-item-preview"> This </p>
                  </div>
                ...
                <li>
                  ...
                  <div class="news-item-detail"> <a class="news-item-title" target="_blank">TCP/IP相关 #1</a>
                    <p class="news-item-preview"> App products.</p>
                  </div>
                ...
                <li>
                  ...
                  <div class="news-item-detail"> <a  class="news-item-title" target="_blank">Redis 简单 #1</a>
                    <p class="news-item-preview"> Formify </p>
                  </div>
